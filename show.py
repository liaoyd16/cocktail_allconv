...
if __name__ == '__main__':
    ...
    for sample_dir in sample_dirs:
        ...
        cv2.imwrite(os.path.join("./images/", sample_dir, "ground_truth.png"), ground_truth * AMP)
        cv2.imwrite(os.path.join("./images/", sample_dir, "recover.png"), recover * AMP)
    ...
    for sample_dir in sample_dirs:
        os.system("mkdir {}".format(os.path.join("./images/", sample_dir)))
        for pair_dir in ['pair_0']:#os.listdir(os.path.join(all_samples_path, sample_dir)):
