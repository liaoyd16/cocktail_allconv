...
class ResAE(nn.Module):
    def __init__(self, keepsize_num_en, keepsize_num_de, shortcut):
        ...
        self.upward_net2 = nn.Sequential(
            nn.Conv2d(in_channels=16, out_channels=16, padding=(1,1), stride=(3,3), kernel_size=(4,4), dilation=(1,1)),
            nn.BatchNorm2d(16),
            nn.ReLU(),
            ResBlock(16, 64),
        ...
        self.upward_net3 = nn.Sequential(
            nn.Conv2d(in_channels=64, out_channels=64, padding=(0,0), stride=(3,3), kernel_size=(4,4), dilation=(1,1)),
            nn.BatchNorm2d(64),
            nn.ReLU(),
            ResBlock(64, 128),
        ...
        self.upward_net4 = nn.Sequential(
            nn.Conv2d(in_channels=128, out_channels=128, padding=(0,0), stride=(3,3), kernel_size=(5,4), dilation=(1,1)),
            nn.BatchNorm2d(128),
            nn.ReLU(),
            ResBlock(128, 128),
            *[ResBlock(128, 128) for _ in range(keepsize_num_en)]
        ...
        self.downward_net4 = nn.Sequential(
            *[ResBlock(128, 128) for _ in range(keepsize_num_de)],
            ResBlock(128, 128),
            nn.ConvTranspose2d(in_channels=128, out_channels=128, padding=(0,0), stride=(3,3), kernel_size=(7,5), dilation=(1,1)),
            nn.BatchNorm2d(128),
            nn.ReLU()
        )
        ...
        self.downward_net3 = nn.Sequential(
            *[ResBlock(128, 128) for _ in range(keepsize_num_de)],
            ResBlock(128, 64),
            nn.ConvTranspose2d(in_channels=64, out_channels=64, padding=(0,0), stride=(3,3), kernel_size=(4,4), dilation=(1,1)),
            nn.BatchNorm2d(64),
            nn.ReLU()
        )
        ...
        self.downward_net2 = nn.Sequential(
            *[ResBlock(64, 64) for _ in range(keepsize_num_de)],
            ResBlock(64, 16),
            nn.ConvTranspose2d(in_channels=16, out_channels=16, padding=(1,1), stride=(3,3), kernel_size=(6,4), dilation=(1,1)),
            nn.BatchNorm2d(16),
            nn.ReLU()
        )
    ...
    def upward(self, specgrams, attentions):                # 1, 256, 128
